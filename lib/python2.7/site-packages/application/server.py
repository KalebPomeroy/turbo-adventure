...
def serve():
    ...
    application = Application(route.get_routes(), debug=options.debug)
    ...
    socketio = tornado.web.Application(
        [tornadio.get_router(MyConnection).route()],
        socket_io_port = options.port + 100)
